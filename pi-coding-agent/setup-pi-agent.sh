...
ALIAS_CMD="alias pi-docker='docker run -it --rm --ipc=host -v \"\$(pwd)\":/workspace -v pi_config:/root/.pi/agent:z -v ~/.gitconfig:/root/.gitconfig:ro --env-file ~/.pi-env ${IMAGE_NAME}'"
BASHRC="${HOME}/.bashrc"
